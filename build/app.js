...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index_tsx_1 = __webpack_require__(234);
	var Pattern_tsx_1 = __webpack_require__(229);
	...
	var Test = (function (_super) {
	    ...
	    Test.prototype.render = function () {
	        return (React.createElement("div", null, "test index"));
	    };
	    return Test;
	}(React.Component));
	var App = (function (_super) {
	    ...
	    App.prototype.render = function () {
	        return (React.createElement(react_router_1.Router, {history: appHistory}, React.createElement(react_router_1.Route, {path: "/", component: Test}), React.createElement(react_router_1.Route, {path: "/patterns/", component: Main_tsx_1.default}, React.createElement(react_router_1.IndexRoute, {component: Index_tsx_1.default}), React.createElement(react_router_1.Route, {path: "(:test)", component: Pattern_tsx_1.default}))));
	    };
	    return App;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./draft.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./draft.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var react_router_1 = __webpack_require__(160);
	var Menu_1 = __webpack_require__(228);
	var Main = (function (_super) {
	    ...
	    Main.prototype.render = function () {
	        return (React.createElement("div", {className: "container"}, React.createElement("nav", {className: "nav-main"}, React.createElement("div", {className: "wrap"}, React.createElement(react_router_1.Link, {className: "nav-home", to: "/"}, "Typed Patterns"), React.createElement("ul", {className: "nav-site"}, React.createElement("li", null, React.createElement("a", {href: "https://github.com/totallytyped/typed-patterns"}, "Github"))))), React.createElement("section", {className: "content wrap documentationContent"}, React.createElement("div", {className: "nav-docs"}, React.createElement("div", {className: "nav-docs-section"}, React.createElement("h3", null, "All patterns"), React.createElement(Menu_1.default, null))), React.createElement("div", {className: "inner-content"}, this.props.children)), React.createElement("footer", null, React.createElement("div", {className: "wrap"}, React.createElement("div", {className: "right"}, "Typed Patterns © 2016")))));
	    };
	    return Main;
	}(React.Component));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var react_router_1 = __webpack_require__(160);
	var Pattern_1 = __webpack_require__(229);
	var App = (function (_super) {
	    __extends(App, _super);
	    function App() {
	        _super.apply(this, arguments);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var PrismCode_1 = __webpack_require__(230);
	exports.patterns = {
	    'Test': {
	        codeExample: ''
	    },
	...
	Object.keys(exports.patterns).forEach(function (e) {
	    exports.patterns[e].codeExample = __webpack_require__(231)("./" + e + ".tsx");
	});
	...
	var Pattern = (function (_super) {
	    ...
	    Pattern.prototype.render = function () {
	        return (React.createElement("div", null, exports.patterns[this.props.params.test] ?
	            React.createElement("div", null, React.createElement("h1", null, this.props.params.test), React.createElement(PrismCode_1.default, {className: "language-typescript"}, exports.patterns[this.props.params.test].codeExample)) :
